    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Secure access for authorized staff only</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="staff@sparklesphere.store"
                />
              </div>
            </div>
            ...
            <div className="bg-yellow-500/20 border border-yellow-500/50 rounded-lg p-3">
              <p className="text-xs text-yellow-100 flex items-start gap-2">
                ...
                <span>
                  This is a secure staff area. All login attempts are monitored and logged.
                </span>
              </p>
            </div>
